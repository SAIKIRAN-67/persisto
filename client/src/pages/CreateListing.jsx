...
//                     </div>
//                     <div className='flex items-center gap-2 '>
//                         <input type='number' id='regularprice' min='50' max='10000000' required className='p-3 border-gray-300 rounded-lg' onChange={handleChange} value={formData.regularPrice}/>
...
//                     </div>
//                     <div className='flex items-center gap-2 '>
//                         <input type='number' id='discountprice' min='50' max='1000000' required className='p-3 border-gray-300 rounded-lg' onChange={handleChange} value={formData.discountPrice}/>
//                         <div className='flex flex-col items-center'>
...
//                         <buttton type="button" onClick={()=>{handleRemoveImage(index)}} className="p-3 text-red-700 rounded-lg uppercase hover:opacity-75 cursor-pointer">Delete</buttton>
//                     </div>
//                 ))}
