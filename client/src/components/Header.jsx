...
//                 <Link to="/"> <li className='hidden sm:inline  text-slate-400 hover:underline'>Home</li></Link>
//                 <Link to="/about"><li className='hidden sm:inline  text-slate-400 hover:underline'>About</li></Link>
//                 <Link to="/profile">
//                     {currentUser?(
//                         <img className='rounded-full h-7 w-7 object-cover' src={currentUser.avatar} alt='profile'/>
//                     ):(
//                         <li className='  text-slate-400 hover:underline'>Sign In</li>
//                     )
//                 }
//                 </Link>
//             </ul>
